...
import * as _$es_toolkit_compat0 from "es-toolkit/compat";
import { camelCase } from "es-toolkit/compat";
import * as _$yummies_types0 from "yummies/types";
import { AnyObject, Maybe, Primitive } from "yummies/types";
import * as _$swagger_schema_official0 from "swagger-schema-official";
import * as _$es_toolkit0 from "es-toolkit";
import * as _$eta from "eta";
...
declare class SchemaRoutes {
   ...
   */
  extractTypeNameWithoutSchemaKeyCollision: (routeNameUsage: string, options: any) => string | null;
  ...
  parseRouteInfo: (rawRouteName: any, routeInfo: any, method: any, resolvedSwaggerSchema: ResolvedSwaggerSchema, parsedSchemas: any, routeServers: any) => ParsedRoute;
...
declare class SwaggerSchemaResolver {
  ...
  processSwaggerSchemaFile(file: string): _$yummies_types0.AnyObject;
...
interface GenerateApiParamsFromSpecLiteral extends Partial<GenerateApiConfiguration["config"]> {
   ...
   * swagger schema JSON
   */
  spec: _$swagger_schema_official0.Spec;
}
...
type RawRouteInfo = _$swagger_schema_official0.Operation & {
  operationId: string;
  method: string;
  route: string;
  moduleName: string;
  ...
  tags?: string[];
  summary?: string;
  responses?: _$swagger_schema_official0.Operation["responses"];
  produces?: string[];
  requestBody?: object;
  consumes?: string[];
};
...
interface GenerateApiConfiguration {
  ...
  utils: {
    ...
    _: typeof _$es_toolkit0 & typeof _$es_toolkit_compat0;
...
interface GenerateApiOutput {
  ...
  renderTemplate: (templateContent: string, data: Record<string, unknown>, etaOptions?: Partial<_$eta.EtaConfig>) => Promise<string> | string;
  getTemplate: (params: {
    fileName?: string;
    name?: string;
    path?: string;
...
declare function generateApi(config: Partial<GenerateApiConfiguration["config"]>): Promise<{
  ...
  configuration: GenerateApiConfiguration | {
    ...
    utils: {
      ...
      formatDescription: (description: string | undefined, inline?: boolean) => string;
      escapeJSDocContent: (content: unknown) => string;
      internalCase: typeof _$es_toolkit_compat0.camelCase;
      classNameCase: typeof pascalCase;
      pascalCase: typeof pascalCase;
      getInlineParseContent: (schema: SchemaParserConfig["schema"], typeName: string | null, schemaPath: string[]) => Record<string, any>;
      getParseContent: (schema: SchemaParserConfig["schema"], typeName: string | null, schemaPath: string[]) => Record<string, any>;
