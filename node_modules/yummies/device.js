...
* ```
*/
var getUserAgent = () => (navigator.userAgent || navigator.vendor || globalThis.opera || "").toLowerCase();
/**
...
* ```
*/
var checkIsTouchDevice = () => checkIsMobileDevice() || checkIsTabletDevice();
var isMobileDevice = checkIsMobileDevice();
var isTabletDevice = checkIsTabletDevice();
var isTouchDevice = isMobileDevice || isTabletDevice;
//#endregion
export { checkIsMobileDevice, checkIsTabletDevice, checkIsTouchDevice, getUserAgent, isMobileDevice, isTabletDevice, isTouchDevice };
